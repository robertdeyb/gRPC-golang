...
type CreateBlogResponse struct {
	...
	Blog *Blog `protobuf:"bytes,1,opt,name=blog,proto3" json:"blog,omitempty"` //wil have a blog id
}
...
func (x *DeleteBlogRequest) GetBlogId() int64 {
	if x != nil {
		return x.BlogId
	}
	return 0
...
func (x *DeleteBlogResponse) GetBlogId() int64 {
	if x != nil {
		return x.BlogId
	}
	return 0
...
var file_blog_blogpb_blog_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x06, 0x62, 0x6c, 0x6f, 0x67, 0x49, 0x64, 0x22, 0x32, 0x0a, 0x10, 0x52, 0x65,
	...
	0x0a, 0x07, 0x62, 0x6c, 0x6f, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x07, 0x62, 0x6c, 0x6f, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06,
...
type BlogServiceClient interface {
	...
	// GetBlog returns the user profile by its unique user id.
