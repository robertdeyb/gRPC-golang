...
type GreetWthDeadlineResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GreetWthDeadlineResponse) Reset() {
	*x = GreetWthDeadlineResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreetWthDeadlineResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetWthDeadlineResponse) ProtoMessage() {}

func (x *GreetWthDeadlineResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetWthDeadlineResponse.ProtoReflect.Descriptor instead.
func (*GreetWthDeadlineResponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{10}
}

func (x *GreetWthDeadlineResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x69, 0x6e, 0x67, 0x22, 0x32, 0x0a, 0x18, 0x47, 0x72, 0x65, 0x65, 0x74, 0x57, 0x74,
	...
	0x1f, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x57, 0x74, 0x68,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*GreetWthDeadlineResponse)(nil), // 10: greet.GreetWthDeadlineResponse
}
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	10, // 14: greet.GreetService.GreetWithDeadline:output_type -> greet.GreetWthDeadlineResponse
...
func file_greet_greetpb_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greet_greetpb_greet_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreetWthDeadlineResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type GreetServiceClient interface {
	...
	//unary with Deadline
	GreetWithDeadline(ctx context.Context, in *GreetWithDeadlineRequest, opts ...grpc.CallOption) (*GreetWthDeadlineResponse, error)
}
...
func (c *greetServiceClient) GreetWithDeadline(ctx context.Context, in *GreetWithDeadlineRequest, opts ...grpc.CallOption) (*GreetWthDeadlineResponse, error) {
	out := new(GreetWthDeadlineResponse)
...
type GreetServiceServer interface {
	...
	//unary with Deadline
	GreetWithDeadline(context.Context, *GreetWithDeadlineRequest) (*GreetWthDeadlineResponse, error)
}
...
func (*UnimplementedGreetServiceServer) GreetWithDeadline(context.Context, *GreetWithDeadlineRequest) (*GreetWthDeadlineResponse, error) {
